...
module.exports = function () {
    ...
    router.get('/update_post_form/:id', function (req, res) {
        console.log('Loading the post update page');
        var callbackCount = 0;
        var context = {};
        var mysql = req.app.get('mysql');
        getSinglePost(res, mysql, context, req.params.id, complete);
        function complete() {
            callbackCount++;
            if (callbackCount >= 1) {
                res.render('update_post_form', context);
            }
        }
    });
    */
    ...
    router.post('/update_comment/:id', function (req, res) {
        var mysql = req.app.get('mysql');
        console.log(req.body);
        //console.log(req.params.id);
    ...
    // Delete a comment
    router.post('/delete_comment/:id', function (req, res) {
